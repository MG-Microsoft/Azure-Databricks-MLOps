...
white_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/mohammadg@microsoft.com/winequality_white.csv", sep=';')
red_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/mohammadg@microsoft.com/winequality_red.csv", sep=';')
...
# MAGIC %sh 
# MAGIC curl -i -X POST -H "X-Databricks-Org-Id: 8268128686751071" -H "Authorization: Bearer dapicd4f67bede04636c6b4098aa285715d9-2" https://adb-8268128686751071.11.azuredatabricks.net/api/2.0/preview/mlflow/transition-requests/create -d '{"comment": "Please move this model into Staging!", "model_version": {"version": 1, "registered_model": {"name": "wine_quality"}}, "stage": "Staging"}'
...
# MAGIC curl                                                \
# MAGIC   -X POST                                           \
# MAGIC   -H "X-Databricks-Org-Id: 8268128686751071"        \
# MAGIC   -H "Authorization: Bearer dapicd4f67bede04636c6b4098aa285715d9-2"        \
# MAGIC   -d '{"model_version": {
# MAGIC          "registered_model" : {
# MAGIC            "name" : "wine_quality"
# MAGIC          },
# MAGIC          "version" : 1},
# MAGIC        "stage" : "Staging",
# MAGIC        "comment" : "Please move this model into Staging!"
# MAGIC       }'                                            \
# MAGIC https://adb-8268128686751071.11.azuredatabricks.net/api/2.0/preview/mlflow/transition-requests/create
